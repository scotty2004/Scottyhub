...
// credentials — so the wildcard fallback here does NOT send credentials.
// Set FRONTEND_URL in production to your real domain to enable credentialed
// requests (cookies / Authorization header) from that origin specifically.
